...
[Home](./index.md) &gt; [@microsoft/teamsfx-bot](./teamsfx-bot.md) &gt; [TeamsBotSsoPrompt](./teamsfx-bot.teamsbotssoprompt.md)
...
|  --- | --- | --- |
|  [(constructor)(dialogId, settings, authConfig)](./teamsfx-bot.teamsbotssoprompt._constructor_.md) |  | <b><i>(BETA)</i></b> Constructor of TeamsBotSsoPrompt. |

## Methods

|  Method | Modifiers | Description |
|  --- | --- | --- |
|  [beginDialog(dc)](./teamsfx-bot.teamsbotssoprompt.begindialog.md) |  | <b><i>(BETA)</i></b> Called when a prompt dialog is pushed onto the dialog stack and is being activated. |
|  [continueDialog(dc)](./teamsfx-bot.teamsbotssoprompt.continuedialog.md) |  | <b><i>(BETA)</i></b> Called when a prompt dialog is the active dialog and the user replied with a new activity. |
